...
> github.com/voidfy69/Radium-Nuker
...
"""
    ...
    # mass create roles
        ...
        count = Funcs.get_input("how many times do you want to send this message? [1, 8]: ", lambda x: x.isnumeric() and int(x) != 0)
...
def start(args):
    ...
    System.Clear()
    System.Title("Discord Nuker - github.com/voidfy69/Radium-Nuker")
    System.Size(160, 40)
